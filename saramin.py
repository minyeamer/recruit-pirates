...
class Saramin(Content):
    ...
    def set_params(self):
        ...
        # self.params['loc-cd'] = ','.join(loc_list)
        # self.params['job-cd'] = ','.join(job_list)
        self.params['loc-cd'] = '101000'
        self.params['job-cd'] = '181'
    ...
    def match_code_map(self, texts: list, codes: dict) -> list:
        ...
        return [ codes[text] if text in code_keys else '' for text in texts ]
    ...
    def make_content(self):
        ...
        for recruit in recruits:
            ...
            recruit_info['href'] = company['href']
            recruit_info['id'] = recruit['id']
            ...
            recruit_info['salary'] = recruit['salary']
            ...
            self.content[company['name']] = recruit_info
